  ...
  return (
    <>
      ...
      <div className="pt-20 pb-24 lg:w-[80%] mx-auto">
        {/* Hero */}
        <div className="relative sm:h-[50vh] md:h-[70vh]" id="início">
        ...
        {/* Conteúdo */}
        <div className="max-w-7x2 mx-auto px-6 md:px-12 pt-18" id="sobre">
